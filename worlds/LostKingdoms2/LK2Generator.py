...
CUSTOM_MAGIC_CRYSTALS_CODE = CUSTOM_ATTRIBUTE_UP_CODE+88
CUSTOM_HEAL_CODE = CUSTOM_MAGIC_CRYSTALS_CODE+76
CUSTOM_CARD_RETURN_CODE = CUSTOM_HEAL_CODE+76
PROGRESSIVE_LEVELING_TRIGGER = 0X8025d01d
CUSTOM_ATTRIBUTE_UP_TRIGGER = 0x8025d01c
GIVE_MAGIC_CRYSTALS_TRIGGER = 0x8025d0e0
GIVE_HEALTH_TRIGGER = 0x8025d0e1
GIVE_CARD_BACK_TRIGGER = 0x8025d0e2
GIVE_MAGIC_CRYSTALS_FUNCTION = 0x800160e4
...
class LK2Randomizer:
    ...
    def modify_code(self,iso_file):
        ...
        #self.patch_iso_from_ram(iso_file, CUSTOM_CODE_ADDRESS_2+52, self.make_bl(CUSTOM_CODE_ADDRESS_2+52, CUSTOM_CARD_RETURN_CODE))
